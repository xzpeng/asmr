...
<div class="clear"></div>
    <div id="main">
        <form action="__URL__/doPublishProduct" method="post" enctype="multipart/form-data">
            产品链接：<input name="plink" type="text" /><a href="">采集</a>
            <br />
            报名类别：
            <select name="pcategary1">
                <option>aaaaaaa</option>
                <option>bbbbbbb</option>
                <option>ccccccc</option>
            </select>
            <select name="pcategary2">
                <option>ddddddd</option>
                <option>eeeeeee</option>
                <option>fffffff</option>
            </select>
            <select name="pcategary3">
                <option>ggggggg</option>
                <option>hhhhhhh</option>
                <option>iiiiiii</option>
            </select>
            <br />
            商品原价：<input name="porginalprice" type="text" /> 折后价：<input name="pdiscount" type="text" />
            <br />
            提交活动标准预览图：<input name="pimage" type="file" />（标准为：000x000像素）
            <br />
            联系人：<input name="cname" type="text" />
            <br />
            QQ：<input name="cqq" type="text" />
            <br />
            手机：<input name="cmobile" type="text" />
            <br />
            邮箱：<input name="cemail" type="text" />
            <br />
