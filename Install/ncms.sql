...
CREATE TABLE IF NOT EXISTS `nc_production` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `category` varchar(100) NOT NULL COMMENT '产品类型',
  `subcategory` varchar(100) NOT NULL,
  `discount` int(10) unsigned NOT NULL COMMENT '折扣',
  `title` varchar(120) NOT NULL COMMENT '标题',
  `href` varchar(180) NOT NULL COMMENT '产品链接',
  `img` varchar(18) DEFAULT NULL COMMENT '图片',
  `display` varchar(1) NOT NULL DEFAULT '0' COMMENT '显示',
  `top` int(1) NOT NULL DEFAULT '0' COMMENT '置顶',
  `original_price` int(10) unsigned NOT NULL COMMENT '原价',
  `discount_price` int(10) unsigned NOT NULL COMMENT '折后价',
  `cname` varchar(20) NOT NULL COMMENT '联系人',
  `cqq` int(15) unsigned NOT NULL COMMENT 'QQ',
  `cmobile` int(15) unsigned NOT NULL COMMENT '手机',
  `cemail` varchar(120) NOT NULL COMMENT '邮箱',
...
CREATE TABLE IF NOT EXISTS `nc_vip` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `idcard_a` varchar(18) DEFAULT NULL COMMENT '身份证正面',
  `idcard_b` varchar(18) DEFAULT NULL COMMENT '身份证背面',
  `auth` varchar(1) NOT NULL DEFAULT '0' COMMENT '显示',
  `name` varchar(20) NOT NULL COMMENT '姓名',
  `qq` int(15) unsigned NOT NULL COMMENT 'QQ',
  `mobile` int(15) unsigned NOT NULL COMMENT '手机',
...
CREATE TABLE IF NOT EXISTS `nc_ad` (
  ...
  `position` varchar(18) DEFAULT NULL COMMENT '位置',
  `image` varchar(18) DEFAULT NULL COMMENT '图片',
  `display` varchar(1) NOT NULL DEFAULT '0' COMMENT '显示',
  `link` varchar(120) NOT NULL COMMENT '链接',
  `discribe` varchar(120) NOT NULL COMMENT '描述',
  `register_time` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;
